...
const (
  ...
  InsertSegment = "INSERT INTO trip_segments SET (user_id, beacon_identifier, trip_id, check_in_type, transport_station_id, latitude, longitude, passed_at) VALUES($1, $2, $3, $4, $5, $6, $7, $8);"
)
